...
void setup() {
  ...
  mcp.digitalWrite(7, HIGH); //Turn off 12VS rail. We do not need it for this program.
  mcp.pinMode(4, OUTPUT);
  mcp.digitalWrite(4, HIGH); //Turn off 3VS rail. We do not need it for this program.
