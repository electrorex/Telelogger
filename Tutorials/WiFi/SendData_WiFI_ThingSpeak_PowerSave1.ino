 ...
 * 
 * This is a modification of the original script to disable WiFi modem and sleep the processor in between intervals of the loop
 */
...
WiFiClient client;
char ssid[] = "XXXXXXX";        //Replace with your network SSID (name)
char pass[] = "XXXXXXXX";    // Replace with your network password 
